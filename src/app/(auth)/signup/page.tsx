...
export default function SignupPage(){
    ...
    useEffect(()=>{
        if(user.role.length>0 && user.email.length>0 && user.password.length>0 && user.username.length>0){
    ...
    return(
        ...
        <div className="flex flex-col justify-center items-center h-screen w-screen">
            ...
            <label htmlFor="role" className="z-10">
                    Role
                </label>
                <select
                    id="role"
                    ...
                    className="z-10 p-4 my-2 rounded-md focus:outline-none focus:ring focus:border-blue-300"
                >
